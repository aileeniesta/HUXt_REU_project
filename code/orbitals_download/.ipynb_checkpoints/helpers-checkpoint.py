...
def get_earth_lon(t):
    """
    Returns Carrington longitude of Earth at UTC time t.
    Assumes Carrington rotation system anchored to _CR0 and _CR_LEN.
    """
    cr_num, cr_start = carrington_info(t)
    earth_carr_lon = ((t - cr_start).to('day').value / _CR_LEN) * 360.0 % 360.0
    return earth_carr_lon
